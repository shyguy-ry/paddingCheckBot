...
import logging
#Enable for debug mode, where the bot prints the response group and username of the user selected to the console
debug = True
...
Certified_Big = ["aliothfox","socallioncub","poofpatrollerbot","daycareCheckBot"]
